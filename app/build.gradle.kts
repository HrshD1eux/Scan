...
android {
    ...
    signingConfigs {
        create("release") {
            ...
            storePassword = System.getenv("ORG_GRADLE_PROJECT_STORE_PASSWORD") ?: "release123"
            keyAlias = System.getenv("ORG_GRADLE_PROJECT_KEY_ALIAS") ?: "release"
            keyPassword = System.getenv("ORG_GRADLE_PROJECT_KEY_PASSWORD") ?: "release123"
        }
    }
